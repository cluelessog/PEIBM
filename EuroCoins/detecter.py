...
def trainCoinClass(visual):
    ...
    with open('train'+os.sep+'zips'+os.sep+'newCoin.zip', 'rb') as coin,\
        ...
        model = visual.create_classifier('euros',coin_positive_examples=coin, euro1_positive_examples=euro1,\
                                                 ...
                                                 cent50_positive_examples=cent50,negative_examples=notCoins).get_result()
